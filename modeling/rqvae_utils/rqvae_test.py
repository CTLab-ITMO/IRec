...
if __name__ == "__main__":
    ...
    tensor_embeddings = torch.tensor(embeddings_array, dtype=torch.float32, device=DEVICE)
    ...
    cos_sim = torch.nn.functional.cosine_similarity(tensor_embeddings, decoder_output, dim=1)
    ...
    l2_dist = torch.norm(decoder_output - tensor_embeddings, p=2, dim = 1) / (norm_a + norm_b + 1e-8)
