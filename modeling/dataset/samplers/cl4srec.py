...
class Cl4SRecTrainSampler(TrainSampler, config_name='cl4srec'):
    ...
    def _apply_crop_augmentation(self, item_sequence):
        ...
        crop_start_index = np.random.randint(low=0, high=len(item_sequence) - num_elements_to_crop + 1)
    ...
    def _apply_reorder_augmentation(self, item_sequence):
        ...
        reorder_start_index = np.random.randint(low=0, high=len(item_sequence) - num_elements_to_reorder + 1)
        ...
        item_sequence = item_sequence[:reorder_start_index] \
