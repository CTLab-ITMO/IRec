...
class LastItemPredictionTrainSampler(
    TrainSampler, config_name="last_item_prediction_neg"
):
...
class LastItemPredictionEvalSampler(
    EvalSampler, config_name="last_item_prediction_neg"
):
    @classmethod
    def create_from_config(cls, config, **kwargs):
        return cls(
