...
class InteractionsDataset(BaseDataset, config_name='interactions'):
    ...
    def create_from_config(cls, config, **kwargs):
        ...
        train_dataset, train_num_interactions, train_max_user_idx, train_max_item_idx = cls._create_dataset(
            data_dir_path, 'train')
        max_user_idx, max_item_idx = max(max_user_idx, train_max_user_idx), max(max_item_idx, train_max_item_idx)

        test_dataset, test_num_interactions, test_max_user_idx, test_max_item_idx = cls._create_dataset(data_dir_path,
                                                                                                        'test')
