...
class S3RecModel(SequentialTorchModel, config_name='s3rec'):
    ...
    def forward(self, inputs):
        ...
        if self._is_training:
            ...
            positive_item_events = inputs['{}.ids'.format(self._positive_prefix)][mip_mask]  # (all_batch_events)
            negative_item_events = inputs['{}.ids'.format(self._negative_prefix)][mip_mask]  # (all_batch_events)
            ...
            positive_segment_embeddings, positive_segment_mask = self._apply_sequential_encoder(
            ...
            negative_segment_embeddings, negative_segment_mask = self._apply_sequential_encoder(
