...
class DuoRecModel(SequentialTorchModel, config_name='duorec'):
    ...
    def forward(self, inputs):
        ...
        if self.training:  # training mode
            ...
            training_output['similar_sequence_representation'] = last_embeddings_
            assert not torch.allclose(last_embeddings, last_embeddings_), \
...
class DuoRecMCLSRModel(SequentialTorchModel, config_name='duorec_mclsr'):
